...
const SidebarLeft =()=> {
    ...
    return (
        <section className={`min-w-[16%] dark:bg-dark-m bg-white border-r-2 border-gray-200 dark:border-r-1 dark:border-gray-600 h-screen  fixed shadow-md z-50 md:flex flex-col hidden`}>
            ...
            <div className={"bg-light-m dark:bg-dark-m py-4  w-full h-full"}>
                <Tabs variant='line'>
                    <TabList>
                        ...
                        <Tab _selected={{ color: `white`, bg:`${COLORS.bleu02}` }}>
                            <div className={"flex items-center gap-1"}>
                                <IoShareSocial size={15} color={resolvedTheme=="dark" ? "white":`${COLORS.rose01}`}/>
                        ...
                        </Tab>
                        {
                          ...
                          sessionDetail?.data?.dj?.id==sessionData?.djId &&  //@ts-ignore
                            <Tab _selected={{color: `white`, bg: `${COLORS.bleu02}`}}>
                            <div className={"flex items-center gap-1"}>
                                <CiSettings size={15} color={resolvedTheme == "dark" ? "white" : `${COLORS.rose01}`}/>
                    ...
                    <TabPanels>
                        <TabPanel>
                           <div className={"flex flex-col gap-10 items-center md:h-[60rem]"}>
                               <div className={"flex flex-col gap-5 items-center max-h-full w-[100%]  overflow-y-auto customer-scrollbar"}>
                                   {
